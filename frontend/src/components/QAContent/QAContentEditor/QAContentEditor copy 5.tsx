...
const QAContentEditor: React.FC = () => {
        ...
        for (const section of sections) {
            ...
            for (const answer of section.answers) {
                if (!answer.answer.trim()) {
                    alert(`Answer ID: ${answer.id} in Question ID: ${section.id} is empty.`);
                    return false;
                }
                if (answer.childQuestion && !validateSections([answer.childQuestion])) {
                    return false;
                }
            }
        }
    ...
    // Render individual QA section with recursion
