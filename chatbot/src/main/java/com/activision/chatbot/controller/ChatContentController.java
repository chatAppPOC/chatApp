...
public class ChatContentController {
	...
	public ResponseEntity<?>  updateContentv2(@RequestParam Long titleId, @RequestParam Long contentId, @NotBlank @RequestParam String name, @RequestBody com.activision.chatbot.model.Content chatContent) {
		try {
